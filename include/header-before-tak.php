         ...
         <div class="auto-container">
            <div class="clearfix">
               ...
               <div class="pull-left logo-outer">
                  <div class="logo"><a href="/"><img src="images/Logo111.png" alt="Carpet Shop Dubai" title="Carpet Shop Dubai"></a></div>
               </div>
              ...
              <!--START Wodde Wall Cladding-->
                               ...
                               <li class="dropdown">
                              <a href="flooring.php">Wooden Wall Panels </a>
                              <ul class="bb">
      ...
      <div class="sticky-header">
         <div class="auto-container clearfix">
            ...
            <div class="logo pull-left">
               <a href="index.php" class="img-responsive"><img src="images/logo-small.png" alt="Cartpet Shop Dubai" title=""></a>
            </div>
            <!--Right Col-->
                  ...
                  <div class="navbar-collapse collapse clearfix">
                     <ul class="navigation clearfix">
                        ...
                        <li class="has-dropdown">
                              <a href="our-services-in-abu-dhaib.php">Our Services In Abu Dhabi▾</a>
                              <ul class="dropdown">
                                 <li><a href="epoxy-flooring-in-abu-dhabi.php">Epoxy Flooring In Abu Dhabi</a></li>
                                 <li><a href="spcflooringabudabhi.php">SPC-Flooring Abu Dhabi</a></li>
